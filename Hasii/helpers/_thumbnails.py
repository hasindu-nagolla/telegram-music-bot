...
from Hasii import config
from Hasii.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("Hasii/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("Hasii/helpers/Inter-Light.ttf", 30)
