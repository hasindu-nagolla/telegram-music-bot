...
from HasiiMusic.misc import SUDOERS, mongodb
from HasiiMusic.plugins import ALL_MODULES
from HasiiMusic.utils.database import get_served_chats, get_served_users, get_sudoers
from HasiiMusic.utils.decorators.language import language, languageCB
from HasiiMusic.utils.inline.stats import (
...
async def handle_back_to_stats(client, callback_query, _):
    is_sudo = callback_query.from_user and (
        callback_query.from_user.id in SUDOERS)
    keyboard = build_stats_keyboard(_, is_sudo)
